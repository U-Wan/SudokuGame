...
import com.tsu.sudokugame.model.game.CellConflict;
import com.tsu.sudokugame.model.game.CellConflictList;
...
public class GameController implements IModelChangedListener, Parcelable {
    ...
    public void loadNewDailySudokuLevel() {
        ...
        createboard difficultyCheck = new createboard(GameType.Default_9x9, GameDifficulty.Unspecified);
        difficultyCheck.setRecordHistory(true);
        difficultyCheck.setPuzzlee(level);
